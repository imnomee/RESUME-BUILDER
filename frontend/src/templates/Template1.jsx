...
const Template1 = ({ userData }) => {
    return (
        <div className="w-full flex justify-center overflow-x-auto py-6">
            <div
                className="relative w-[794px] max-w-full transform transition-transform"
                id="resume">
                {/* Even Smaller Scaling for Mobile */}
                <div className="scale-100 md:scale-85 sm:scale-60 xs:scale-50 origin-top">
                    <section className="left w-2/5">
                        <div className="mb-2">
                            <h1 className="font-serif text-5xl md:text-4xl sm:text-3xl font-semibold mb-3 tracking-wide">
                                {userData.name}
                            </h1>
                            <p className="text-lg sm:text-base underline underline-offset-6">
                                {userData.title}
                            </p>
                        </div>
                        <div className="flex flex-col gap-2 mb-4">
                            <div className="flex items-center gap-2">
                                <LuMessageCircleMore className="text-lg sm:text-base" />
